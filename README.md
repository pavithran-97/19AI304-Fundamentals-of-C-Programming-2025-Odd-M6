...
// Function definition using static storage class
void display(int n) {
    static float base = 100.25;  // static variable retains value between calls
    float sum;

    sum = base + n;
    printf("Sum = %.2f\n", sum);

    base = base + 100.25;  // increment base for next call
}
...
int main() {
    ...
    printf("\nCalling display() function 5 times:\n");
    for (i = 0; i < 5; i++) {
        display(input);
    }
...
```
# Output:
<img width="336" height="182" alt="image" src="https://github.com/user-attachments/assets/55f9c0b1-2bd9-43b3-9085-c5364daaebad" />
...
```
# Output:
<img width="365" height="305" alt="image" src="https://github.com/user-attachments/assets/6d29083c-9179-4208-b1e4-735db725736b" />
...
```
# Output:
<img width="350" height="587" alt="image" src="https://github.com/user-attachments/assets/19362141-93fa-44f2-ac88-e7dcc1d99894" />
...
void findAge(struct date *d) {
    ...
    // Adjust days if birth date > current date
    if (d->b_date > d->c_date) {
        d->c_date += month[d->c_month - 2]; // add days of previous month
        d->c_month -= 1;
    }

    // Adjust months if birth month > current month
...
```
# Output:
<img width="371" height="126" alt="image" src="https://github.com/user-attachments/assets/0cb10124-a8d0-4d5f-94e0-5f070cab8702" />
...
```
# Output:
<img width="188" height="64" alt="image" src="https://github.com/user-attachments/assets/165de3ee-cd8b-46fe-ba3c-15bacba22fe4" />
